            ...
            {transferType === "wire" && (
              <div className="space-y-4 p-4 rounded-3xl border border-amber-500/20 bg-amber-500/10 hidden">
                <div className="flex items-center gap-2 text-amber-300 text-sm">
                  ...
                  <span>Wire transfers require IMF and COT verification codes{user?.wireBypassCodes && " (or just PIN if account is approved)"} — codes will be entered in the next step.</span>
                </div>
              </div>
            )}
