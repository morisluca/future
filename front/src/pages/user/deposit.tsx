...
export default function DepositPage() {
  ...
  const handleDeposit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSuccess(pending ? "Deposit submitted — awaiting confirmation." : "Deposit credited to your account.");
    } catch (err: any) {
          ...
          {activeTab === "deposit" && (
            <div className="space-y-6">
                ...
                <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-5 space-y-4">
                  ...
                  {depositInfo.deposit_instructions && (
                    <div className="bg-zinc-900/60 rounded-lg p-3">
                      <p className="text-xs text-zinc-400"><span className="font-semibold text-zinc-300">Instructions: </span> <span style={{color:"yellow"}}>{depositInfo.deposit_instructions}</span></p>
                    </div>
                  )}
                </div>
              ) : (
              ...
              <form onSubmit={handleDeposit} className="space-y-4">
                ...
                <div className="border-t border-zinc-800 pt-4 space-y-3 hidden">
                  <p className="text-xs text-zinc-500 hidden">E-mail your deposit receipt to <a href="mailto:contact@securebank.com" className="text-emerald-400 hover:underline">contact@securebank.com</a> for confirmation  </p>
                </div>
                <div className="border-t border-zinc-800 pt-4 space-y-3 hidden">
                  <p className="text-xs text-zinc-500 hidden">Your sending bank details (optional, for verification)</p>
