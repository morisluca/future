...
import { Shield, Loader2, ArrowRight, Download, Delete, LetterTextIcon, ChartBar } from "lucide-react";

import { useAuth } from "@/lib/auth-context";
import { logout, useLogin } from "@/lib/api-client";
    ...
    <div className="min-h-screen bg-background relative flex items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          <div onClick={()=> window.location.href = "/"} className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/20 mb-6">
      ...
      {/*  button */}
      <div className="absolute bottom-6 left-0 right-0 flex justify-center z-10 mt-5">
      </div>
    </div>
  );
}
